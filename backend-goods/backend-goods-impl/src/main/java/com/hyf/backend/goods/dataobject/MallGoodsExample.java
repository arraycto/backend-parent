...
public class MallGoodsExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGalleryCriterion(String condition, Object value, String property) {
            ...
            galleryCriteria.add(new Criterion(condition, value, "com.hyf.backend.common.mybatis.typehandler.JsonListStringTypeHandler"));
            allCriteria = null;
        }

        protected void addGalleryCriterion(String condition, List value1, List value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            galleryCriteria.add(new Criterion(condition, value1, value2, "com.hyf.backend.common.mybatis.typehandler.JsonListStringTypeHandler"));
            allCriteria = null;
        }
