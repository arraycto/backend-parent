...
public class MallTopicExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGoodsCriterion(String condition, Object value, String property) {
            ...
            goodsCriteria.add(new Criterion(condition, value, "com.hyf.backend.common.mybatis.typehandler.JsonListIntegerTypeHandler"));
            allCriteria = null;
        }

        protected void addGoodsCriterion(String condition, List value1, List value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            goodsCriteria.add(new Criterion(condition, value1, value2, "com.hyf.backend.common.mybatis.typehandler.JsonListIntegerTypeHandler"));
            allCriteria = null;
        }
