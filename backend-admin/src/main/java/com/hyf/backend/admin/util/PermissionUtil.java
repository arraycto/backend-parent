package com.hyf.backend.admin.util;

import com.hyf.backend.admin.annotation.RequiresPermissionsDesc;
import com.hyf.backend.admin.controller.vo.PermVO;
...
public class PermissionUtil {
    ...
    public static List<Permission> listSysPermission(ApplicationContext applicationContext, String basicPackage) {
